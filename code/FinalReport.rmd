...
country_code
A unique two-letter ID given to each country.
country
Full name of country.
political_score
The scores reflect the observed level of filtering; focused primarily on Web sites that express views in opposition to those of the current government. Content more broadly related to human rights, freedom of expression, minority rights, and religious movements is also considered here.
Variables:
...
social_score
The scores reflect the observed level of filtering; covers material related to sexuality, gambling, and illegal drugs and alcohol, as well as other topics that may be socially sensitive or perceived as offensive.
Variables:
0 - ONI testing did not uncover an evidence of websites being blocked.
1 - Connectivity abnormalities are present that suggest the presence of filtering, although diagnostic work was unable to confirm conclusively that inaccessible websites are the result of deliberate tampering.
2 - Narrowly targeted filtering that blocks a small number of specific sites across a few categories or filtering that targets a single category or issue.
...
tools_score
The scores reflect the observed level of filtering; web sites that provide e-mail, Internet hosting, search, translation, Voice-over Internet Protocol (VoIP) telephone service, and circumvention methods are grouped in this category.
Variables:
0 - ONI testing did not uncover an evidence of websites being blocked.
1 - Connectivity abnormalities are present that suggest the presence of filtering, although diagnostic work was unable to confirm conclusively that inaccessible websites are the result of deliberate tampering.
2 - Narrowly targeted filtering that blocks a small number of specific sites across a few categories or filtering that targets a single category or issue.
...
conflict/security_score
The scores reflect the observed level of filtering; content related to armed conflicts, border disputes, separatist movements, and militant groups is included in this category.
Variables:
0 - ONI testing did not uncover an evidence of websites being blocked.
1 - Connectivity abnormalities are present that suggest the presence of filtering, although diagnostic work was unable to confirm conclusively that inaccessible websites are the result of deliberate tampering.
2 - Narrowly targeted filtering that blocks a small number of specific sites across a few categories or filtering that targets a single category or issue.
...
transparency
A qualitative measure based on the level at which the country openly engages in filtering.
Variables:
low
medium
high
consistency
The variation in filtering within a country across different ISPs - in some cases the availability of specific Web pages differs significantly depending on the ISP one uses to connect the the Internet.
Variables:
low
medium
high
...
Variables & Description
donornamee
Name of country donating foreign aid
RecipientNameE
Name of country receiving foreign aid
Amount
Total dollar amount in millions of foreign aid exchanged between donornamee and RecipientNameE
...
Variables & Description
iso2c
A unique two-letter or -integer ID given to each country.
country
Full name of country.
year
Year of information.
...
SP.POP.TOTL
Measures size of population.
GC.TAX.TOTL.GD.ZS
Measures tax revenue received by national government.
NY.GDP.MKTP.KD.ZG
Measures year over year population growth from 2011-2012.
...
censorshipAidDonorIntersect = createCensorAidIntersectDF(censorship, foreignAidDonors)
```
...
#plotCensorshipVs(censorship, "Military","GDP_per_cap")
```